...
class MountEdit(Screen, ConfigListScreen):
	...
	skin = """
		<screen name="MountEdit" position="130,150" size="450,240" title="Mount editor">
			...
			<ePixmap position="0,200" zPosition="4" size="140,40" pixmap="skin_default/buttons/red.png" transparent="1" alphatest="on" />
			<ePixmap position="140,200" zPosition="4" size="140,40" pixmap="skin_default/buttons/green.png" transparent="1" alphatest="on" />
